# Full FluxCd and CI demo with k8studio

## Create a kubernetes cluster

Create a local k8Ckuster

```
kind create cluster --name fluxcddemo --image kindest/node:v1.26.3
```
...
```
curl -o /tmp/flux.tar.gz -sLO https://github.com/fluxcd/flux2/releases/download/v2.1.2/flux_2.1.2_darwin_amd64.tar.gz
